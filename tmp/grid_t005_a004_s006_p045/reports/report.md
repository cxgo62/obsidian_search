...
- recall_at_5: 0.4944
- recall_at_10: 0.5111
- precision_at_5: 0.1911
- precision_at_10: 0.1796
- mrr: 0.3778
- coverage: 0.6000
...
- cs/1-33/11 事件总线.md: false_positives_10=cs/1-33/21.1 背压 back pressure.md,cs/1-33/31.3 类kafka结构的问题.md,cs/34-98/71 DDD 下解决多个repo的分布式事务问题.md,cs/34-98/90.0 基于kafka的事物消息.md,cs/34-98/92.4 编制（orchestration）和编排（choreography）.md
...
- cs/目录/高并发 index.md: false_positives_10=cs/1-33/11.3 CQRS 命里和查询分离.md,cs/1-33/30.1 阿里云 DRDS(PolarDB-X).md,cs/1-33/30.1.0 分布式数据库.md,cs/1-33/30.2 proxy的路由的思路.md,cs/1-33/30.2.1 负载均衡策略（前端服务器）.md
- cs/1-33/19 监控报警.md: false_positives_10=cs/1-33/15 软件架构度量.md,cs/1-33/18.1 故障发现.md,cs/34-98/50 ROC AUC 准确率 召回率.md,cs/99-160/112.1.1 Bloom filter principle.md,cs/目录/稳定性index.md
